...
file <- nc_files[grepl("/tmp/RtmpeDAakl/data/netcdf3.0.2new/degree1/enh/sst.mean.nc", nc_files)]
...
```{r}
setwd('~/Downloads')
loss = read.csv("thunderbird.tmp/pid-41614/08302025_2024_aggregate.csv")
met = read.csv("thunderbird.tmp/pid-41614/lf_matched_metrics.csv")
hurdat = read.csv("thunderbird.tmp/pid-41614/hurdat_track-1761700598833.csv")
...
```{r}
# GEV
df_gev = filter(df,is.na(windspeed)==FALSE)
```
