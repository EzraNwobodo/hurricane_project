...
```
```{r}
beta1_chain_means <- sapply(mh_chains, function(ch) mean(ch$samples$beta[,1]))
beta1_chain_means

par(mfrow=c(2,2))
for (k in 1:4) {
  plot(ts(mh_chains[[k]]$samples$beta[,1]),
       main = paste("Chain", k, "beta[1]"))
}
